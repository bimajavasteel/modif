...
FACE_SWAPPER: Dict[int, Any] = {}   # GPU → model
...
def get_face_swapper(device_id: int):
    """Return ONNX model on specific GPU."""
    global FACE_SWAPPER
    with THREAD_LOCK:
...
# ------------------------------------------------------------
# Per-GPU processing fn (worker uses this)
# ------------------------------------------------------------
